...
int* largestDivisibleSubset(int* nums, int numsSize, int* returnSize) {
    ...
    l_set = malloc(numsSize * sizeof(int)); 
    memset(l_set, -1, numsSize * sizeof(int));
    op = malloc(numsSize * sizeof(int)); 
    memset(op, -1, numsSize * sizeof(int));
    visited = malloc(numsSize * sizeof(int)); 
